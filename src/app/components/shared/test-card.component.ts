  ...
  template: `
    <div (click)="goToDetail()"
         ...
         style="background-color: white; overflow: hidden; border-radius: 12px; border: 1px solid;
                 transition: all 200ms cubic-bezier(0.34, 1.56, 0.64, 1); cursor: pointer; height: 340px;">
      ...
      <div style="position: relative; height: 160px;">
        ...
        <div *ngIf="!imageUrl"
          ...
          <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M20 16C20 13.7909 21.7909 12 24 12H40C42.2091 12 44 13.7909 44 16V52H20V16Z"
                  stroke="var(--soft-blue-white)" stroke-width="3" stroke-linecap="round"/>
            <circle cx="32" cy="32" r="6" stroke="var(--soft-blue-white)" stroke-width="3"/>
          </svg>
        </div>
      ...
      <div style="padding: 24px; display: flex; flex-direction: column; justify-content: space-between;
        ...
        <div>
          ...
          <div style="display: flex; align-items: baseline; gap: 8px; margin-bottom: 8px;">
            ...
            <span *ngIf="savings > 0"
                  style="padding: 2px 8px; font-size: 11px; background-color: var(--savings-bg);
                         color: var(--success-green); border-radius: 99px; font-weight: 600;">
              Save ₹{{ savings }}
            </span>
          </div>
        </div>
...
export class TestCardComponent {
  ...
  goToDetail() {
    this.router.navigate([`/tests/${this.id}`]);
  }
}
